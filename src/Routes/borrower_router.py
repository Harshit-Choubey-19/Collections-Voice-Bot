...
@router.patch("/borrower/{borrower_id}/language")
async def update_language(borrower_id: str, language: str):
    """Update borrower's preferred language after language selection on call."""
    try:
